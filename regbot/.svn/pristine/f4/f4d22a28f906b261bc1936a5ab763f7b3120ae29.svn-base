...
#if !defined(I2C_T3_H) && (defined(__MK20DX128__) || defined(__MK20DX256__) || defined(REGBOT))
#define I2C_T3_H
...
public:
    ...
    //                        command should end with a STOP (I2C_STOP) - switch to rx-mode or not (I2C_NOSTOP) stay in tx-mode. 
    //                        Use done() or finish()
